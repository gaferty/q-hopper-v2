...
csv.each do |row|
  ...
  Restaurant.create(name: Faker::Restaurant.name, cuisine: Faker::Restaurant.type, details: Faker::Restaurant.description, longitude: 0.0, latitude: 0.0, user: owner, address: "somewhere")
end
